...
import zuidaliu.util.EdgeUtil;
import zuidaliu.util.NodeUtil;
import zuidaliu.entry.Edge;
import zuidaliu.entry.Node;
/**
	...
	public static double edmondsKarpMaxFlow(double graph[][],int s,int t)
	{
		...
		while(result!=null)
		{
			...
			while(result.getParent()!=null)
			{
				...
				//System.out.println(f[result.nodeId][parent.nodeId]);
				//f[result.nodeId][parent.nodeId]-=cfp;
				//System.out.println(f[result.nodeId][parent.nodeId]+"===");
				result=parent;
			}
